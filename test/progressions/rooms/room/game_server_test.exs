defmodule Progressions.GameServerTest do
  ...
  describe "pregame lobby" do
    test "fills up and progresses to game start" do
      room_id = "1"
    ...
    test "handles musicians joining and dropping" do
      # TODO
    end
  end

  describe "game start" do
    test "collects all ready ups and progresses to recording" do
      room_id = "1"
      musician_ids = ["musician1", "musician2", "musician3"]
  ...
  describe "recording" do
    test "collects all recordings and progresses to playback voting" do
      room_id = "1"
      musician_ids = ["musician1", "musician2", "musician3"]
  ...
  describe "playback voting" do
    test "collects all votes and progresses to next round" do
      room_id = "1"
      musician_ids = ["musician1", "musician2", "musician3"]
      ...
      assert [%{"musician1" => 0}, %{"musician1" => 0}, %{"musician1" => 1}] =
               Enum.reverse(scores)
    end

    test "collects all votes and progresses to game end" do
      room_id = "1"
      musician_ids = ["musician1", "musician2", "musician3"]
      ...
      assert [%{"musician1" => 1}, %{"musician1" => 1}, %{"musician1" => 2}] =
               Enum.reverse(scores)
    end
  end
end
