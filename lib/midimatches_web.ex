defmodule MidimatchesWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: MidimatchesWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/midimatches_web/templates",
        namespace: MidimatchesWeb
  ...
  def router do
    quote do
      ...
      import Plug.Conn
      import Phoenix.Controller
      import MidimatchesWeb.RateLimiter
  ...
  defp view_helpers do
    quote do
      ...
      import MidimatchesWeb.ErrorHelpers
      import MidimatchesWeb.Gettext
      alias MidimatchesWeb.Router.Helpers, as: Routes
    end
  end
