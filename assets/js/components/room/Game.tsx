        ...
        switch (currentView) {
          case GAME_VIEW.START:
            ...
            return (
              <GenericView
                ...
                nextViewCallback={() => setCurrentView(GAME_VIEW.INPUT_TEST)}
              />
            );
          case GAME_VIEW.INPUT_TEST:
            ...
            return (
              <GenericView
                currentView={currentView}
                nextViewCallback={() =>
                  setCurrentView(GAME_VIEW.SAMPLE_RECORDING)
                }
              />
            );
          case GAME_VIEW.SAMPLE_RECORDING:
            console.log("SAMPLE_RECORDING");
            return <RecordingView channelPushCallback={pushMessageToChannel} />;
          case GAME_VIEW.SAMPLE_PLAYBACK:
            console.log("SAMPLE_PLAYBACK");
            return (
              <GenericView
                currentView={currentView}
                nextViewCallback={() => setCurrentView(GAME_VIEW.VOTING)}
              />
            );
          case GAME_VIEW.VOTING:
            ...
            return (
              <GenericView
                currentView={currentView}
                nextViewCallback={() => setCurrentView(GAME_VIEW.RESULTS)}
              />
            );
          case GAME_VIEW.RESULTS:
            ...
            return (
              <GenericView
                currentView={currentView}
                nextViewCallback={() => setCurrentView(GAME_VIEW.START)}
              />
            );
          default:
            return (
