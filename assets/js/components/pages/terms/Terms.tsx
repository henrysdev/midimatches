...
const TermsPolicy: React.FC = () => {
  return (
    <div className="inset_3d_border_shallow inline_screen privacy_page_info">
      <dl>
        <dt>
          <h4>OVERVIEW</h4>
        </dt>
        <dd>
          <p>
            This website is operated by Midi Matches. Throughout the site, the
            terms “we”, “us” and “our” refer to Midi Matches. Midi Matches
        ...
        <dd>
          <p>
            ...
            Midi Matches, our directors, officers, employees, affiliates,
        ...
        <dd>
          <p>
            You agree to indemnify, defend and hold harmless Midi Matches and
        ...
        <dt>
          <h4>SECTION 20 - PROFILE PICTURES AND CONTENT</h4>
        </dt>
        <dd>
          <p>
            Nudity or sexual content Sexually explicit content like pornography
            is not allowed. In other words, your profile photo cannot include
            mature or offensive content. For example, do not use a photo that is
            a close-up of a person’s buttocks or cleavage. Images containing
            fetish content will be removed depending on the severity of the act
            in question. Do not distribute sexually explicit or pornographic
            material. Do not drive traffic to commercial pornography sites. In
            most cases, violent, graphic, or humiliating fetishes are not
            allowed to be shown on Midi Matches. Violent or graphic content It's
            not okay to post violent or gory content that's primarily intended
            to be shocking, sensational, or disrespectful. Illegal Activities Do
            not use our Services to engage in illegal activities or to promote
            activities that are dangerous and illegal, such as terrorism, the
            sale of illegal drugs, or human trafficking.{" "}
          </p>
        </dd>
        <br />

        <dt>
          <h4>SECTION 21 - USE OF MULTIPLE ACCOUNTS</h4>
        </dt>
        <dd>
          <p>
            Do not create or use multiple accounts to evade our policies or
            bypass blocks or otherwise subvert restrictions placed on your
            account. For example, if you’ve been blocked by another user or
            suspended for abuse, don’t create a replacement account that engages
            in similar activity.{" "}
          </p>
        </dd>
        <br />
        ...
        <dt>
          <h4>SECTION 22 - SPAM</h4>
        </dt>
        <dd>
          <p>
            Spam, scams, etc Everyone hates spam. It's not okay to post large
            amounts of untargeted, unwanted or repetitive content, including
            comments and private messages. If you are reported to be spamming
            then there will be consequences such as being muted for a certain
            amount of time or eventually being banned from Midi Matches.{" "}
          </p>
        </dd>
        <br />

        <dt>
          <h4>SECTION 23 - CONTACT INFORMATION</h4>
        </dt>
        <dd>
          <p>
            Questions about the Terms of Service should be sent to us at
            midimatches@gmail.com.
          </p>
        </dd>
        <br />
      </dl>
