...
export class NotePlayer{
  ...
  _scheduleDueNotesForPlay(): void {
    const dueTimestepSlice = this.loopPlaybackManager.getDueTimestepSlices(this.currentTimestep);
...
setTimeout(() => {
  loopPlaybackManager.updateMusicianLoop(mocks.classicalLoopLH, defaultMusician1.musician_id);
}, 5000);
setTimeout(() => {
  loopPlaybackManager.updateMusicianLoop(mocks.classicalLoopRH, defaultMusician1.musician_id);
}, 7000);
/* END DEBUG HARNESS */
